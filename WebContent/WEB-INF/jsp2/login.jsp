...
<base href="" />
	...
	<link href="web/templates/rt_sirocco/css-compiled/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
	<style type="text/css">
	...
	<script src="web/modules/mod_roknavmenu/themes/default/js/jquery.min.js"></script>
		...
		<input type="hidden" name="Itemid" value="99999" />
			...
			<div class="rt-header-fixed-spacer"></div>
           	...
           	<div class="module-surround">
					...
					<h2 class="title"><span>Login or Sign Up</span></h2>			</div>
	                		                	<div class="module-content">
...
<div class="row" style="margin-top:20px">
    <div class="col-xs-12 col-sm-8 col-md-8 col-sm-offset-2 col-md-offset-3">
		...
		<input type="hidden" name="source" value="login">
			<fieldset>
				...
				<div class="form-group">
                    <input type="email"  id="email" name="username" value=<c:if test="${not empty username}">${username}</c:if> class="form-control input-lg" placeholder="Email Address">
				</div>
				<div class="form-group">
				...
				<div class="row">
					<div class="col-xs-6 col-sm-6 col-md-6">
                        <input type="hidden" class="btn btn-lg btn-success btn-block" value="SignUp" name="source">
					</div>
					<div class="col-xs-6 col-sm-6 col-md-6">
        ...
        <div class="clear"></div>
			             			            ...
			             			            <div class="rt-block box1 title3 rt-mainbody-wrapper rt-grid-6 ">
           	<div class="module-surround">
	           				<div class="module-title">
