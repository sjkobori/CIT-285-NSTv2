		...
		<input type="hidden" name="Itemid" value="99999" />
			...
			<div class="rt-header-fixed-spacer"></div>
           	...
           	<div class="module-surround">
					...
					<h2 class="title"><span>Sing Up</span></h2>			</div>
	                		                	<div class="module-content">
...
<div class="control-group">
			<div class="control-label">
			<label  id="jform_contact_name-lbl" for="username" class="hasPopover required" name="username">
	UserName<span class="star">&#160;*</span></label>
					</div> 
		<div class="controls"><input type="text" name="username"  id="jform_contact_name"  value="" class="required" size="30"       required aria-required="true"      />
</div>
</div>
...
<div class="control-group">
			<div class="control-label">
			<label id="jform_contact_name-lbl" for="password" class="hasPopover required"name="title" >
	Password<span class="star">&#160;*</span></label>
					</div>
		<div class="controls"><input type="password" name="password" id="jform_contact_name"  value="" class="required" size="30"       required aria-required="true"      />
</div>
</div>
...
<div class="control-group">
			<div class="control-label">
			<label id="jform_contact_name-lbl" for="firstname" class="hasPopover required" name="authorLastName" >
	First Name<span class="star">&#160;*</span></label>
					</div>
		<div class="controls"><input type="text" name="firstname" id="jform_contact_name"  value="" class="required" size="30"       required aria-required="true"      />
</div>
</div>
...
<div class="control-group">
			<div class="control-label">
			<label id="jform_contact_name-lbl" for="lastname" class="hasPopover required" name="edition" >
	Last Name<span class="star">&#160;*</span></label>
					</div>
		<div class="controls"><input type="text" name="lastname" id="jform_contact_name"  value="" class="required" size="30"       required aria-required="true"      />
</div>
</div>
...
<div class="control-group">
			<div class="control-label">
			<label id="jform_contact_name-lbl" for="companyname" class="hasPopover required" name="edition" >
	Company Name<span class="star">&#160;*</span></label>
					</div>
		<div class="controls"><input type="text" name="companyname" id="jform_contact_name"  value="" class="required" size="30"       required aria-required="true"      />
</div>
</div>
...
<div class="control-group">
			<div class="control-label">
			<label id="jform_contact_name-lbl" for="email" class="hasPopover required" name="edition" >
	Email<span class="star">&#160;*</span></label>
					</div>
		<div class="controls"><input type="text" name="email" id="jform_contact_name"  value="" class="required" size="30"       required aria-required="true"      />
</div>
</div>
</br>
...
<div class="control-group">
			<div class="control-label">
			<label id="jform_contact_name-lbl" for="city" class="hasPopover required" name="edition" >
	city<span class="star">&#160;*</span></label>
					</div>
		<div class="controls"><input type="text" name="city" id="jform_contact_name"  value="" class="required" size="30"       required aria-required="true"      />
</div>
</div>

<div class="control-group">
			<div class="control-label">
			<label id="jform_contact_name-lbl" for="street" class="hasPopover required" name="edition" >
	Street<span class="star">&#160;*</span></label>
					</div>
		<div class="controls"><input type="text" name="street" id="jform_contact_name"  value="" class="required" size="30"       required aria-required="true"      />
</div>
</div>

<div class="control-group">
			<div class="control-label">
			<label id="jform_contact_name-lbl" for="zipcode" class="hasPopover required" name="edition" >
	Zipcode<span class="star">&#160;*</span></label>
					</div>
		<div class="controls"><input type="text" name="zipcode" id="jform_contact_name"  value="" class="required" size="30"       required aria-required="true"      />
</div>
</div>
														...
														<div class="control-group">
			<div class="controls">
				<button class="btn btn-primary validate" type="submit" value="Submit">Submit</button>
